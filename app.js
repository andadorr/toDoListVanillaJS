...
(function(arrOfTasks) {
  ...
  themeSelect.addEventListener('change', onThemesSelectHandler);
  ...
  function onThemesSelectHandler(e) {
    const selectedThemes = themeSelect.value;
    const isConfirmed = confirm(`Are you sure to want change theme with:${selectedThemes}`);
    if (!isConfirmed) {
      themeSelect.value = lastThemeName;
      return;
    }
    setThemes(selectedThemes);
    lastThemeName = selectedThemes;
  }
